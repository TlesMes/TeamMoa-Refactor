...
| **300** | **364.5** | **456** | 87ms | 150ms | 0% | **정상 (정점)** |
...
VU 25~200 구간의 평균 기울기 **1.286 RPS/VU** 로 예측한 값과 실측을 비교:

| VU | 25 | 50 | 100 | 150 | 200 | 250 | 300 | 400 | 600 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 예측 | 32.2 | 64.3 | 128.6 | 192.9 | 257.2 | 321.6 | 385.9 | 514.5 | 771.8 |
| 실측 | 32.2 | 64.5 | 128.9 | 192.6 | 255.7 | 309.9 | 364.5 | 357.5 | 348.4 |
| **괴리** | +0.1% | +0.3% | +0.2% | −0.2% | **−0.6%** | −3.6% | −5.5% | **−30.5%** | −54.9% |

### 핵심 결론

| | 값 |
|---|---|
| **선형 확장 구간** | VU 25~200 (오차 ±0.6% 이내, p95 30~52ms 유지) |
