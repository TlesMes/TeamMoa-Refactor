...
#### 3. **Shares 앱 현대화** (진행 예정)
- [ ] **검색 기능** - 제목/내용 검색, 작성자 필터
- [ ] **태그 기능** - 게시물 태그 분류 및 필터링
- [ ] **파일 드래그 앤 드롭** 업로드
- [ ] 댓글/대댓글 시스템 (보류)
- [ ] 리치 텍스트 에디터 (보류)
...
2. **Shares 게시판 검색 기능** - 제목/내용/작성자 검색 구현
3. **Shares 태그 시스템** - 게시물 태그 추가 및 필터링
4. **Shares 파일 업로드 개선** - 드래그 앤 드롭 지원
5. **OAuth 소셜 로그인 구현** - GitHub OAuth → Google OAuth 순차 구현
